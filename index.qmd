...
```
    │
    ├── [my_project]
    │   └── my_project.Rproj  (X Positron)
    │
    ├── [another_project]
    │   └── another_project.Rproj  (X Positron)
    │
    ├── [again_another_project]
    │   └── again_another_project.Rproj  (X Positron)
    │
```
...
- La plupat sont propriétaires/privées et/ou payantes (e.g. Dryad, https://datadryad.org/), d'autres sont institutionnelles (https://forge.ird.fr)
