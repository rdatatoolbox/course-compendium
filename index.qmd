...
::: {.callout-note}
## Utilisez les ~~projets RStudio~~ folders Positron
Travaillez selon le modèle : "1 projet = 1 compendium = 1 répertoire".
<br/> <br/>
L'utilisation d'un projet RStudio / d'un folder Positron permet de se retrouver à la racine du projet à son ouverture.
:::
...
::: {.column .fragment}
![](assets/img/setwd_VS_rproj-positron.png)
:::
:::
...
![](assets/img/setwd_VS_rproj-positron.png){width="100%" fig-align="center"}

## Organisation (projets) {auto-animate=true}

![](assets/img/setwd_VS_rproj-positron.png){width="300" fig-align="center"}
...
Il existe des modèles d'organisation plus ou moins complexes, on adaptera la compléxité du compendium à celle du projet (ou de son cerveau).
...
- La plupat sont propriétaires/privées et/ou payantes (e.g. [Dryad](https://datadryad.org/), d'autres sont institutionnelles [IRD](https://forge.ird.fr))
...
## {background-image="assets/img/r-desc_miracle.png"}
