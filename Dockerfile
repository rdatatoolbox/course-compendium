...
RUN apt-get update -y && apt-get install -y  make  git  libcurl4-openssl-dev  libssl-dev  libgit2-dev  libicu-dev  pandoc  libudunits2-dev  libgdal-dev  gdal-bin  libgeos-dev  libproj-dev  libsqlite3-dev && rm -rf /var/lib/apt/lists/*
